...
#include "CubeWithTextureApplication.h"
#include "glm/glm.hpp"
...
CubeWithTextureApplication::CubeWithTextureApplication() : GLApplication(GetAbsolutePath("shader.vsh"), GetAbsolutePath("shader.fsh"))
{
    vao_id_ = 0;
    vbo_ids_[0] = 0;
    vbo_ids_[1] = 0;
