...
#include "DiffuseReflectionApplication.hpp"
#include "glm/glm.hpp"
...
DiffuseReflectionApplication::DiffuseReflectionApplication() : GLApplication("shader.vsh", "shader.fsh")
{
    vaoId = 0;
    vboIds[0] = 0;
    vboIds[1] = 0;
...
bool DiffuseReflectionApplication::init()
{
    ...
    model = glGetUniformLocation(programObject, "m_model");
    m_mvp = glGetUniformLocation(programObject, "m_mvp");
    
    modelNormal = glGetUniformLocation(programObject, "m_modelNormal");
...
void DiffuseReflectionApplication::render(GLuint x, GLuint y, GLuint width, GLuint height)
{
    ...
    glUniformMatrix4fv(this->model, 1, false, &model[0][0]);
    glUniformMatrix4fv(m_mvp, 1, false, &proj[0][0]);
    
    glm::mat4 modelofnormal = glm::transpose(glm::inverse(model));
    glUniformMatrix4fv(modelNormal, 1, false, &modelofnormal[0][0]);
